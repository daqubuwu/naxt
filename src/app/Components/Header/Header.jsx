...
const Header = () => {
  ...
  return (
    <header className='flex items-center justify-between px-6 py-2 text-2xl sticky top-0 z-1000'>
      ...
      <nav className="header-nav flex items-center gap-5">
        <div className='header-theme' onClick={toggleTheme}>
          <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
            width="18" height="18" viewBox="0 0 1049.000000 1280.000000"
            preserveAspectRatio="xMidYMid meet">
            <g transform="translate(0.000000,1280.000000) scale(0.100000,-0.100000)"
              fill="#000000" stroke="none">
              <path fill="#ffffff" fill-rule="evenodd" d="M6015 12789 c-740 -46 -1469 -219 -2145 -509 -284 -121 -817 -407
...
116 100 115 98 115 132 0 52 -22 59 -186 58 -82 -1 -207 -6 -279 -10z"/>
        ...
        <div className='header-menu'>
          <svg width="21px" height="21px" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" fill="none">
