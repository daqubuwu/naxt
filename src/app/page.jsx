...
export default function Home() {
  return (
    ...
    <div className="flex justify-center gap-x-24 pr-72 pt-32">
      <div className="bg-cover ml-20 rounded-xl">
      <Image src="/7.jpeg" width={447} height={631} alt="test" />
      </div>
      <div className="visits-schedule flex">
        <div className="item p-4 text-white">

          <div className="item-info flex gap-14 mt-6">
            <p className="item-city text-4xl uppercase">Nuenen and Antwerp</p>
            <p className="item-date text-4xl text-right text-gray-400">1883</p>
          </div>
          <p className="item-place font-light text-xl text-gray-300 uppercase">painting intern</p>

          <div className="item-info flex justify-between gap-14 mt-6">
            <p className="item-city text-4xl uppercase">Paris</p>
            <p className="item-date text-4xl text-right text-gray-400">1886</p>
          </div>
          <p className="item-place font-light text-xl text-gray-300 uppercase">Junior Painter</p>

          <div className="item-info flex justify-between gap-14 mt-6">
            <p className="item-city text-4xl uppercase">Gauguin's visit</p>
            <p className="item-date text-4xl text-right text-gray-400">1888</p>
          </div>
          <p className="item-place font-light text-xl text-gray-300 uppercase">Experimental artist</p>

          <div className="item-info flex justify-between gap-14 mt-6">
            <p className="item-city text-4xl uppercase">Saint-Rémy</p>
            <p className="item-date text-4xl text-right text-gray-400">1889</p>
          </div>
          <p className="item-place font-light text-xl text-gray-300 uppercase">Senior Painter</p>

          <div className="item-info flex justify-between gap-14 mt-6">
            <p className="item-city text-4xl uppercase">Auvers-sur-Oise</p>
            <p className="item-date text-4xl text-right text-gray-400">1890</p>
          </div>
          <p className="item-place font-light text-xl text-gray-300 uppercase">painting studio manager</p>
